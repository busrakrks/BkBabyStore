...
using BkBabyStore.Service.Concrete;
...
app.MapControllerRoute(  //bunu yazarak admin anasayfanýn gelmesini saðladýk
			name: "admin",
...
// Katmanlý Mimari Ýliþki Hiyerarþisi   //databasecontexte hata verince bu kýsmý yaptýn mý bak 
